...
namespace procesos_app.Controllers
{
    public class EstudianteController : Controller
    {
        ...
        public ActionResult Inicio()
        {
            ...
            var estSection = (from s in _context.Sections
                              ...
                              join std in _context.StudentSection on s.Id equals std.SectionId
                              ...
                              where std.StudentId == currentUser
                              select new
                              {
                                  Id = std.Id,
                                  Codigo = subj.Codigo,
                                  Seccion = s.Name,
                                  Materia = subj.Name,
                                  Profesor = u.FirstName + " " + u.SecondName + " " +
                                         u.LastName + " " + u.SecondLastName,
                                  Creditos = subj.QtyCredits,
                                  Horario = sch.Day + " de " + sch.StartTime.Hour + " a " + sch.EndTime.Hour,
                                  Aula = b.NickName + " " + s.ClassRoom.Name
                              }).ToList();
